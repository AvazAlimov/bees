        ...
        <div class="container-fluid">
            <div class="row text-center">
                <div class="col-sm-12 confirm">
                    ...
                    <h3>Начните использовать Asalari.uz </h3>
                ...
                <div class="col-sm-12 info text-center">
                    ...
                    {{$example}}
                    <h4>
                        Вы почти готовы начать работу с Asalari.uz. Пожалуйста, подтвердите свой адрес электронной почты, чтобы мы знали, что это действительно вы.
                    </h4>
                    <hr>
