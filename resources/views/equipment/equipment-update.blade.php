    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <form class="for-horizontal" method="POST" action="{{ route('equipment.update', $family->id) }}"
                      id="form">
                    {{ csrf_field() }}
                    <div class="panel panel-default">
                        <div class="panel-heading">Обновление оборудования</div>
                        <div class="panel-body">
                            <div class="col-md-12 form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-3 control-label">Имя:</label>
                                <div class="col-md-9">
                                    <input id="name" type="text" class="form-control" name="name"
                                           value="{{$family->name}}" required autofocus>
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-12 form-group{{ $errors->has('volume_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input id="volume_name" type="text" class="form-control" name="volume_name"
                                           value="{{$family->volume_name}}" required autofocus>
