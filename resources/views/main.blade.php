                    ...
                    <form class="container tab-pane fade show" aria-labelledby="nav-user_2-tab" id="user_2">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control form-control-sm" id="region_2" name="region"
                                        onchange="regionChanged(this.id)" required>
                                    @foreach($regions as $region)
                                        <option value="{{$region->id}}">{{ $region->name }}</option>
                                    @endforeach
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="mahalla_2" class="col-form-label col-form-label-sm">Маҳалла (МФЙ)
                                    номи</label>
                                <input type="text" class="form-control form-control-sm" id="mahalla_2" name="mahalla"
                                       required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="date_2" class="col-form-label col-form-label-sm">Корхона давлат рўйҳатидан
                                    ўтган сана</label>
                                <input type="date" class="form-control form-control-sm" id="date_2" name="date"
                                       required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="bank_2" class="col-form-label col-form-label-sm">Хизмат кўрсатиладиган банк
                                    номи</label>
                                <input type="text" class="form-control form-control-sm" id="bank_2" name="bank"
                                       required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control form-control-sm" id="region_3"
                                        onchange="regionChanged(this.id)" name="region" required>
                                    @foreach($regions as $region)
                                        <option value="{{$region->id}}">{{ $region->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="mahalla_3" class="col-form-label col-form-label-sm">Маҳалла (МФЙ)
                                    номи</label>
                                <input type="text" class="form-control form-control-sm" id="mahalla_3" name="mahalla"
                                       required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="date_3" class="col-form-label col-form-label-sm">Корхона давлат рўйҳатидан
                                    ўтган сана</label>
                                <input type="date" class="form-control form-control-sm" id="date_3" name="date"
                                       required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="bank_3" class="col-form-label col-form-label-sm">Хизмат кўрсатиладиган банк
                                    номи</label>
                                <input type="text" class="form-control form-control-sm" id="bank_3" name="bank"
                                       required>
                            </div>
                            <div class="form-group col-md-6">
                    ...
                    <form class="container tab-pane fade show" aria-labelledby="nav-user_4-tab" id="user_4">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control form-control-sm" id="region_4" name="region"
                                        onchange="regionChanged(this.id)" required>
                                    @foreach($regions as $region)
                                        <option value="{{$region->id}}">{{ $region->name }}</option>
                                    @endforeach
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="mahalla_4" class="col-form-label col-form-label-sm">Маҳалла (МФЙ)
                                    номи</label>
                                <input type="text" class="form-control form-control-sm" id="mahalla_4" name="mahalla"
                                       required>
                            </div>
                            <div class="form-group col-md-6">
