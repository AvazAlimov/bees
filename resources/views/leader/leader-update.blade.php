    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <form class="for-horizontal" method="POST" action="{{ route('leader.update', $leader->id) }}">
                    {{ csrf_field() }}
                    <div class="panel panel-default">
                        <div class="panel-heading">Изменить Лидера</div>
                        <div class="panel-body">
                            <div class="col-md-12 form-group{{ $errors->has('firstName') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input id="firstName" type="text" class="form-control" name="firstName"
                                           value="{{ $leader->firstName }}" required autofocus>
                            ...
                            <div class="col-md-12 form-group{{ $errors->has('lastName') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input id="lastName" type="text" class="form-control" name="lastName"
                                           value="{{ $leader->lastName }}" required autofocus>
                            ...
                            <div class="col-md-12 form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input id="email" type="email" class="form-control" name="email"
                                           value="{{ $leader->email }}" required autofocus>
                                    @if ($errors->has('email'))
                                        <span class="help-block">
                            ...
                            <div class="col-md-12 form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input id="phone" type="text" class="form-control" name="phone"
                                           value="{{ $leader->phone }}" required autofocus>
                                    @if ($errors->has('phone'))
                                        <span class="help-block">
                            ...
                            <div class="col-md-12 form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8  col-lg-push-0">
                                    <input id="username" type="text" class="form-control" name="username" value="{{ $leader->username }}" required>
