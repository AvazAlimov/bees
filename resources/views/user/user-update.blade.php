                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="type" id="type">
                                        ...
                                        <option value="1" {{$user->type == 1 ? "selected" : ""}}>Корхона/ЯТТ</option>
                                        <option value="2" {{$user->type == 2 ? "selected" : ""}}>Кўп тармоқли фермер
                                            хўжаликлари
                                        </option>
                                        <option value="3" {{$user->type == 3 ? "selected" : ""}}>Деҳқон (шахсий ёрдамчи)
                                            хўжаликлари
                                        </option>
                                        <option value="4" {{$user->type == 4 ? "selected" : ""}}>Жисмоний шахс</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
